    ...
    <section className=" flex items-center max-xl:flex-col-reverse gap-10 max-container">
      ...
      <div className=" flex flex-1 flex-col">
        ...
        <p className="mt-4 lg:max-w-lg info-text">
          ...
          unbeatable deals. From premier selections to incredible savings, we offer unparalleled value that sets us apart.
        </p>
        ...
        <div className="mt-11 flex flex-wrap gap-4">
          ...
          <Button label={"Learn More"} iconURL={''} bgColor='bg-white' borderColor='border-slate-gray' textColor='text-slate-gray' />
        </div>
      </div>
    </section>
  );
